...
date: "`r paste0(icon::fa_twitter(), 'sckottie')`"
output: 
...
<ul>
  ...
  <br><br><br>
  <li style="font-size:40px";>One more part of the science workflow that's reproducible</li>
</ul>
...
<ul>
  ...
  <li style="font-size:30px";>Properly tested</li>
  <ul>
    <li style="font-size:30px";><a href="https://github.com/ropensci/webmockr">webmockr</a>/<a href="https://github.com/ropensci/vcr">vcr</a> - See also: <a href="https://ropensci.github.io/http-testing-book/">HTTP testing book `r icon::fa_book()`</a></li>
  </ul>
  <li style="font-size:30px";>Helps if maintainer has domain knowledge</li>
  <ul>
    <li style="font-size:30px";>rOpensci <a href="https://github.com/ropensci/software-review">software review</a> facilitating this</li>
    <li style="font-size:30px";>&amp; why we want new maintainer for <a href="https://github.com/ropensci/rsnps">rsnps</a></li>
  </ul>
</ul>
...
<ul>
  ...
  <li style="font-size:30px";><a href="https://github.com/ropensci/seaaroundus">seaaroundus</a> - Sea Around Us data</li>
  <li style="font-size:30px";><a href="https://github.com/ropensci/rglobi">rglobi</a> - Global Biotic Interactions</li>
</ul>
...
<ul>
  ...
  <li style="font-size:30px";><a href="https://github.com/ropensci/rinat">rinat</a> - iNaturalist client</li>
  <li style="font-size:30px";><a href="https://github.com/ropensci/rbison">rbison</a> - USGS BISON client</li>
  <li style="font-size:30px";><a href="https://github.com/ropensci/rebird">rebird</a> - <mark>eBird data via their API</mark></li>
  <li style="font-size:30px";><a href="https://github.com/CornellLabofOrnithology/auk">auk</a> - <mark>eBird bulk data</mark></li>
  <li style="font-size:30px";><a href="https://github.com/ropensci/rvertnet">rvertnet</a> - VertNet data</li>
  <li style="font-size:30px";><a href="https://github.com/ropensci/rfishbae">rfishbase</a> - Fishbase.org data</li>
  <li style="font-size:30px";><a href="https://github.com/ropensci/finch">finch</a> - Handle Darwin Core</li>
  <li style="font-size:30px";><a href="https://github.com/ropensci/seaaroundus">seaaroundus</a> - Sea Around Us data</li>
...
<ul>
  ...
  <li style="font-size:30px";><a href="https://github.com/CornellLabofOrnithology/auk">auk</a> - eBird bulk data</li>
  <li style="font-size:30px";><a href="https://github.com/ropensci/rvertnet">rvertnet</a> - VertNet data</li>
  <li style="font-size:30px";><a href="https://github.com/ropensci/rfishbae">rfishbase</a> - <mark>Fishbase.org data</mark></li>
  <li style="font-size:30px";><a href="https://github.com/ropensci/finch">finch</a> - Handle Darwin Core</li>
  <li style="font-size:30px";><a href="https://github.com/ropensci/seaaroundus">seaaroundus</a> - <mark>Sea Around Us data</mark></li>
  <li style="font-size:30px";><a href="https://github.com/ropensci/rglobi">rglobi</a> - Global Biotic Interactions</li>
</ul>
...
## .large[rgbif <img src="img/rgbif_logo.png" width="80" style="float:right">]

<h2>Access > 1 billion occurrence records from <a href="https://www.gbif.org/">GBIF</a></h2>


<h2>`r icon::fa_github()` <a href="https://github.com/ropensci/rgbif">ropensci/rgbif</a></h2>

<ul>
  <li style="font-size:30px";>Search for species</li>
  <li style="font-size:30px";>Download occurrence data</li>
  <li style="font-size:30px";>Clean occurrence data</li>
  <li style="font-size:30px";>Make maps</li>
</ul>
...
<ul>
  ...
  <ul>
    <li style="font-size:30px";><a href="https://ropensci.github.io/taxize-book/">taxize book `r icon::fa_book()`</a></li>
  </ul>
...
<ul>
  <li style="font-size:30px";><a href="https://github.com/ropensci/taxize">taxize</a> - <mark>Taxonomic toolbelt (remote data)</mark></li>
  <ul>
    <li style="font-size:30px";><a href="https://ropensci.github.io/taxize-book/">taxize book `r icon::fa_book()`</a></li>
  </ul>
  <li style="font-size:30px";><a href="https://github.com/ropensci/taxa">taxa</a> - <mark>Taxonomic R classes</mark></li>
  <li style="font-size:30px";><a href="https://github.com/ropensci/taxizedb">taxizedb</a> - Leverage dumps of taxonomic database locally</li>
  <li style="font-size:30px";><a href="https://github.com/ropensci/ritis">ritis</a> - USGS's ITIS</li>
  <li style="font-size:30px";><a href="https://github.com/ropensci/rotl">rotl</a> - Open Tree of Life</li>
  <li style="font-size:30px";><a href="https://github.com/ropensci/rentrez">rentrez</a> - NCBI ENTREZ taxonomy database</li>
...
<h2>Access taxonomic data from > 20 sources</h2>


<h2>`r icon::fa_github()` <a href="https://github.com/ropensci/taxize">ropensci/taxize</a></h2>

<ul>
  <li style="font-size:30px";>Resolve misspelled/etc. names</li>
  <li style="font-size:30px";>Search for names</li>
  <li style="font-size:30px";>Taxonomic classifications</li>
  <li style="font-size:30px";>Fetch all taxa up- and down-stream</li>
  <li style="font-size:30px";>Fetch taxonomic synonyms</li>
  <li style="font-size:30px";>Common names to taxonomic and vice versa</li>
</ul>
...
## .large[taxa <img src="img/zach.jpg" width="130" style="float:right">]

<h2>Taxonomic classes &amp; manipulate taxonomy+data</h2>


<h2>`r icon::fa_github()` <a href="https://github.com/ropensci/taxa">ropensci/taxa</a></h2>

<ul>
  <li style="font-size:30px";>Classes for taxonomic data only</li>
  <li style="font-size:30px";>Classes for taxonomic data + user data</li>
  <li style="font-size:30px";>dplyr-like "taxonomically aware" data manipulation</li>
</ul>
...
<ul>
  <li style="font-size:30px";><a href="https://github.com/ropensci/jqr">jqr</a> - R client for <a href="https://github.com/stedolan/jq/">jq</a>, the JSON processor</li>
  <li style="font-size:30px";><a href="https://github.com/ropensci/jsonld">jsonld</a> - JSON linked data</li>
  <li style="font-size:30px";><a href="https://github.com/ropensci/rerddap">rerddap</a> - <mark>ERDDAP server client</mark></li>
  <li style="font-size:30px";><a href="https://github.com/ropensci/rdflib">rdflib</a> - RDF pkg, wrapped around Redland</li>
  <li style="font-size:30px";><a href="https://github.com/ropensci/assertr">assertr</a> - <mark>Assertions for analysis pipelines</mark></li>
</ul>

---

## .large[assertr usage: eg <img src="img/tony.jpg" width="130" style="float:right">]
...
Data: [spp_list.txt](https://github.com/sckott/talks/blob/gh-pages/dataone19/spp_list.txt)

---

## .large[Data integration: code]

<h3>Test assertions about the data</h3>
...
![leaflet_map](img/leaflet_map2.png)
...
<ul>
  <li style="font-size:40px; list-style: none;";>Scott Chamberlain</li>
  <ul>
    <li style="font-size:40px; list-style: none; color: #5688C8";>`r icon::fa_twitter()` sckottie</li>
    <li style="font-size:40px; list-style: none; color: #5688C8";>slides: <a href="https://scotttalks.info/dataone19/">scotttalks.info/dataone19</a></li>
  </ul>
  <li style="font-size:40px; list-style: none;";>Karthik Ram</li>
  <ul>
    <li style="font-size:40px; list-style: none; color: #5688C8";>`r icon::fa_twitter()` _inundata</li>
  </ul>
</ul>
<br><br>
<h2>rOpenSci: <a href="https://ropensci.org/">ropensci.org</a></h2>
