...
<br><br>
<center>
### Find this talk on the web here [http://recology.info/talks/sfuoa](http://recology.info/talks/sfuoa)

### Made with [Slidify](http://slidify.org/); the code [here](https://github.com/sckott/talks/blob/gh-pages/sfuoa/index.Rmd)
