...
```{r ordinationbase1, cache=TRUE, comment=NA, message=FALSE, warning=FALSE, fig.height=7, fig.width=8, fig.align='center'}
data(dune)
...
```{r ordinationggplot, cache=TRUE, comment=NA, fig.align='center'}
