...
noaa(dataset='PRECIP_HLY', location='ZIP:28801', datatype='HPCP', year=1980, month=7, day=17, token="hzGfPCLWFGWdVSkjVIljzQVfkHvlNmeQ")$data

# Search sations including the word "snake"
noaa_search(dataset='GHCND', resulttype='station', text='snake', token="hzGfPCLWFGWdVSkjVIljzQVfkHvlNmeQ")

# Search countries including the word "boulder"
noaa_search(dataset='GHCND', resulttype='city', text='boulder', token="hzGfPCLWFGWdVSkjVIljzQVfkHvlNmeQ")
```
...
library(scales)
library(ggplot2)
out <- noaa(dataset='NORMAL_DLY', station='GHCND:USW00014895', datatype='dly-tmax-normal', year=2010, month=4, token="hzGfPCLWFGWdVSkjVIljzQVfkHvlNmeQ")
noaa_plot(out)
```
